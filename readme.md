# Graph RAG using Neo4j vecotr storage

This is a chat application used to chat with your data in a document.
It uses:
- Neo4j vector store to store vectors
...
- To upload a document to the Neo4j graph, run app.py > select upload docs from dropdown in sidebar > browse and upload document > chat once "success" message appeared. Upload api is called from app.py where the api gets the file, categorize it, extract pages, convert into vector using embedding llm, and load it into the Neo4j Graph.
...
![app.py - upload Data](Screenshots/app_upload_doc.PNG "app.py - upload Data")
...
![app.py - Pre_uploaded Data - select Docs](Screenshots/app_chat.PNG "app.py - Pre_uploaded Data - select Docs")

- To chat with all docs without selecting a particular data, select "all document" toggle.

![app.py - Pre_uploaded Data - select Docs](Screenshots/menu_all_docs_on.png "app.py - Pre_uploaded Data - select Docs")

#### iapp.py

This is a simple chat UI to chat with all the docs in the Neo4j vector DB. 
...
- Clone this repository using
        ...
        git clone https://github.com/KARTHIKEYAN-31/RAG-using-Knowledge-Graph
